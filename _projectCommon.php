 ...
 *******************************************************************************/
	...
	$Nav->addNavSeparator("CDT", 	"/cdt");
   	$Nav->addCustomNav("Download", "/cdt/downloads.php", "_self", 3);
	$Nav->addCustomNav("Documentation", "/cdt/documentation.php", "_self", 3);
	$Nav->addCustomNav("Support", "/cdt/support.php", "_self", 3);
	...
	$Menu->addMenuItem("Download", "/cdt/downloads.php", "_self");
