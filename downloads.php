...
<div id="maincontent">
	<div id="midcolumn">
		...
		<h2>CDT 3.1</h2>
		<p>The CDT can be installed from the Callisto Update Site or the CDT Update Site. The CDT Update Site is
		avalable by entering the following URL as the remote site in the Update Manager.
		<ul>
